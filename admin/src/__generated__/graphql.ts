...
export type PollSetQuery = { __typename?: 'Query', sets: Array<{ __typename?: 'Set', name: string, polls: Array<{ __typename?: 'Poll', name: string, questions: Array<{ __typename?: 'Question', intro_text: string, outro_text: string, options: Array<{ __typename?: 'Option', label: string, valid: boolean }> }> }> }> };
